...
async function seedUser () {
  try {
    ...
    userToBeInserted = await dbService.findOne(model.user,{ 'email':'harshal.dave@gmail.com' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'harshal123',
        'isDeleted':false,
        'email':'harshal.dave@gmail.com',
        'isActive':true,
      ...
      await dbService.update(model.user, { 'email':'harshal.dave@gmail.com' }, userToBeInserted);
    }
    userToBeInserted = await dbService.findOne(model.user,{ 'email':'aditya.pai@gmail.com' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'adi123',
        'isDeleted':false,
        'email':'aditya.pai@gmail.com',
        'isActive':true,
      ...
      userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
      await dbService.update(model.user, { 'email':'aditya.pai@gmail.com' }, userToBeInserted);
    }
...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/bonds/partial-update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/admin/bonds/softdelete/:id',
        role: 'User',
        method: 'PUT' 
      },
      {
      ...
      {
        route: '/admin/bonds/softdeletemany',
        role: 'User',
        method: 'PUT' 
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/create',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/addbulk',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/list',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/count',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/partial-update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/updatebulk',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/softdelete/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/softdeletemany',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/delete/:id',
        role: 'User',
        method: 'DELETE'
      },
      {
      ...
      {
        route: '/device/api/v1/bonds/deletemany',
        role: 'User',
        method: 'POST'
      },
      {
