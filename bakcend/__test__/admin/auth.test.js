...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Alfredo27',
        'password':'jeuPi8mcsoBZdFO',
        'email':'Kaycee.Aufderhar31@hotmail.com',
        'name':'Ms. Ricardo Carroll',
        'userType':authConstant.USER_TYPES.Admin,
        'phone_number':'payment',
        'profile_img':'functionalities',
        'sign_img':'Ball',
        'aadhar_img':'Buckinghamshire',
        'pan_img':'Small',
        'bank_img':'Sports',
        'pan_no':'salmon',
        'aadhar_no':'THX',
        'acc_no':'incentivize',
        'demat_pdf_url':'Georgia',
        'address_line_1':'Ball',
        'address_line_2':'Avon',
        'town':'generate',
        'city':'Director',
        ...
        'income':'model',
        'dob':'2023-11-11T16:18:23.226Z',
        'isAuth':false,
        'mobileNo':'(327) 598-8366'
      });
...
describe('POST /login -> if username and password is correct', () => {
  test('should return user with authentication token', async () => {
    let user = await request(app)
      ...
      .send(
        {
          username: 'Kaycee.Aufderhar31@hotmail.com',
          password: 'jeuPi8mcsoBZdFO'
        }
      );
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Kaycee.Aufderhar31@hotmail.com', });
